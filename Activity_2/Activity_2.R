...
#qnorm will return the value that is associated with a probability
#This gives the value at which all values and below, equal the probability of the argument
#Here I calculate the value of the 95th quantile or a probability of .95
